...
public class MainActivity extends AppCompatActivity {
    final String api = "10b9a3cddc4f9c15165c16d07cadf30b";
    final String WEATHER_URL = "https://api.openweathermap.org/data/2.5/weather";

    final long MIN_TIME = 10000;
    final float MIN_DISTANCE = 5000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherState = findViewById(R.id.status);
        Temperature = findViewById(R.id.temperature);
        mweatherIcon = findViewById(R.id.weather_icon);
        mCityFinder = findViewById(R.id.buttonCity);
